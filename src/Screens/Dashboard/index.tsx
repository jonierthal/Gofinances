    ...
    async function loadTransactions(){
       ...
       .map((item: DataListProps) =>{
            ...
            if(item.type === 'positive'){
                entriesTotal += Number(item.amount); //auto incrementa as entradas
            } else {
                expensiveTotal += Number(item.amount); // auto incrementa as saídas
            }
            ...
            <>
                <Header>
                    <UserWrapper>
                        <UserInfo>
                            <Photo 
                                source={{ uri: 'https://avatars.githubusercontent.com/u/80595367?v=4' }}/>
                            <User>
